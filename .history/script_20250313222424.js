...
function switchLanguage(lang, flag, text) {
    ...
    // Modifie le bouton principal avec le drapeau et le texte sélectionnés
    ...
    // Affiche la bonne langue sur le site
...
document.getElementById('lang-fr').addEventListener('click', function () {
    switchLanguage('fr', 'images/icons/fr.svg', 'Français');
});

document.getElementById('lang-en').addEventListener('click', function () {
    switchLanguage('en', 'images/icons/gb.svg', 'English');
});
